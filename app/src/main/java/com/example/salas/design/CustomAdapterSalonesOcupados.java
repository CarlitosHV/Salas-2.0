...
public class CustomAdapterSalonesOcupados extends BaseAdapter {
    ...
    public CustomAdapterSalonesOcupados(Context context, ArrayList<Salones> listaAnimales) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.cardview_salones,
                    parent, false);
